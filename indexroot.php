            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#" class="text-white">Join The Royal Grand Colombo Circle</a></li>
                ...
                <div class="col-md-3">
                    <h5>Contact Us</h5>
                    <p>The Royal Grand Colombo Colombo<br>
                    1 Galle Face, Colombo 2<br>
                    Sri Lanka</p>
                    <p>Tel: +94 11 788 8888<br>
                    Email: slcm@The Royal Grand Colombo.com</p>
                </div>
            </div>
            <hr class="my-4">
            <div class="row">
                <div class="col-md-6">
                    <p class="mb-0">&copy; 2024 The Royal Grand Colombo International Hotel Management Ltd. All Rights Reserved.</p>
                </div>
                <div class="col-md-6 text-end">
